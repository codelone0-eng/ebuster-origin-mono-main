  ...
  return (
    <div className="min-h-screen bg-black overflow-x-hidden text-white relative">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        <Silk speed={5} scale={1} color="#000000" noiseIntensity={4.3} rotation={0} />
      </div>
      <div className="fixed inset-0 bg-gradient-to-b from-black/80 via-black/70 to-black/90 z-[1] pointer-events-none" />

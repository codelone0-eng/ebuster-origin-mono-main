          ...
          <section className="relative px-4 py-12">
            <div className="container mx-auto max-w-[1440px]">
              <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8">
                <TabsList className="bg-white/[0.05] border border-white/20 p-1.5 gap-1.5 backdrop-blur-xl">
                  <TabsTrigger 
                    value="dashboard" 
                    className="data-[state=active]:bg-white/20 data-[state=active]:text-white data-[state=active]:border-white/40 data-[state=active]:shadow-lg text-white/80 border border-white/10 px-4 py-2.5 rounded-lg transition-all hover:text-white hover:bg-white/10 hover:border-white/20 font-medium"
                  >

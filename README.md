...
9. [🧪 Автотестирование](#автотестирование)
10. [Проблемы и решения](#проблемы-и-решения)
11. [Инструкции по развертыванию](#инструкции-по-развертыванию)
...
Проект включает полноценную систему автотестирования с разделением на 4 категории:
...
Откройте дашборд: **http://localhost:8888**

### Возможности

- 📊 **HTML Dashboard** с общей статистикой и детальными отчётами
- 🔄 **Автообновление** результатов каждые 30 секунд
- 📱 **Telegram-уведомления** после каждого прогона
- 🎯 **Разделение по категориям** для независимого запуска
- 🖥️ **Веб-сервер** для просмотра отчётов
- ⏰ **Cron-интеграция** для автоматического запуска

### Документация

- **[tests/QUICK_START.md](./tests/QUICK_START.md)** - Быстрый старт
- **[tests/TESTING_GUIDE.md](./tests/TESTING_GUIDE.md)** - Полное руководство
- **[tests/SERVER_SETUP.md](./tests/SERVER_SETUP.md)** - Настройка на сервере
- **[tests/SUMMARY.md](./tests/SUMMARY.md)** - Обзор системы
